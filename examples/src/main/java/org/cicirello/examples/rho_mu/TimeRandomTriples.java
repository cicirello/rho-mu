...
public class TimeRandomTriples {
  ...
  @OutputTimeUnit(TimeUnit.NANOSECONDS)
  @BenchmarkMode(Mode.AverageTime)
  public IndexTriple nextIntTripleReturningIndexTriple(ExecutionPlan plan) {
    return generator.nextIntTriple(plan.n);
  }
  ...
  public int[] nextIntTriplePreconstructedArray(ExecutionPlan plan) {
    return generator.nextIntTriple(plan.n, preConstructedArray);
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    URLClassLoader classLoader = (URLClassLoader) TimeRandomTriples.class.getClassLoader();
    ...
    realArgs[args.length] = "TimeRandomTriples";

...
/**
 * Simple program comparing CPU time of RandomIndexer.nextBiasedInt vs ThreadLocalRandom.nextInt to
 * demonstrate the significant time advantage for cases where strict uniformity is not required
...
public class TimingNextBiasedIntMethod {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "5) LOW are the results for bounds that are less than 256 and not powers of 2.");
    System.out.println(
        "6) HIGH are the results for bounds that are greater than 256 and not powers of 2.");

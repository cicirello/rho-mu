...
public final class RandomIndexer {
   ...
   * @deprecated This method has been replace by {@link RandomSampler#sampleReservoir(int, int,
   *     int[])} and will be removed in the next major release.
   */
  @Deprecated
   ...
   * @throws NegativeArraySizeException if k &lt; 0.
   * @deprecated This method has been replace by {@link RandomSampler#sampleReservoir(int, int,
   *     int[], RandomGenerator)} and will be removed in the next major release.
   */
  @Deprecated
  @SuppressWarnings("InlineMeSuggester")
   ...
   * @throws NegativeArraySizeException if k &lt; 0.
   * @deprecated This method has been replace by {@link RandomSampler#samplePool(int, int, int[],
   *     RandomGenerator)} and will be removed in the next major release.
   */
  @Deprecated
  @SuppressWarnings("InlineMeSuggester")
   ...
   * @throws IllegalArgumentException if k &gt; n.
   * @throws NegativeArraySizeException if k &lt; 0.
   * @deprecated This method has been replace by {@link RandomSampler#sampleInsertion(int, int,
   *     int[])} and will be removed in the next major release.
   */
  @Deprecated
  @SuppressWarnings("InlineMeSuggester")
   ...
   * @deprecated This method has been replace by {@link RandomSampler#sample(int, double)} and will
   ...
   * interval [0, n). All n choose k combinations are equally likely.
   *
   * <p>This method chooses among the RandomIndexer.samplePool, RandomIndexer.sampleReservoir, and
   * RandomIndexer.sampleInsertion methods based on the values of n and k.
   *
   ...
   * @throws IllegalArgumentException if k &gt; n.
   * @throws NegativeArraySizeException if k &lt; 0.
   * @deprecated This method has been replace by {@link RandomSampler#sample(int, int, int[])} and

...
/**
 * <p>An EnhancedLeapableGenerator is used to wrap an object of any
 * class that implements {@link RandomGenerator.LeapableGenerator} for the purpose
 ...
 * wrapped object.</p>
 *
 * <p>The methods of the {@link RandomGenerator.LeapableGenerator} interface,
 * such as {@link #leaps}, that return streams of RandomGenerator.JumpableGenerator 
 * are implemented to return streams
 * of EnhancedJumpableGenerator objects that wrap the RandomGenerator.JumpableGenerator
 * objects in the
 * streams returned by the enclosed RandomGenerator.LeapableGenerator. However, additionally
 * this class provides a counterpart, such as {@link #eleaps}, for each of these methods
 * whose return type is explicitly a 
 * stream of EnhancedJumpableGenerator objects to simplify usage without the need to cast
...
public class EnhancedLeapableGenerator extends EnhancedJumpableGenerator implements RandomGenerator.LeapableGenerator {
	...
	/**
	 * Constructs an EnhancedLeapableGenerator to wrap and enhance a given 
	 * {@link RandomGenerator.LeapableGenerator}.
	 *
	...
	/**
	 * Gets an EnhancedLeapableGenerator wrapping an instance of
	 * any random number generator supported by your version of Java
	 * as specified by its name, as documented via the 
	 * {@link RandomGenerator.LeapableGenerator#of}
	 * method.
	 ...
	 * by the {@link RandomGenerator.LeapableGenerator#of} method.
	 *
	 * @return an EnhancedLeapableGenerator wrapping an instance of your chosen
	...
	/**
	 * Creates and returns a new EnhancedLeapableGenerator whose internal
	 * state is an exact copy of this one. Thus, if subjected to the same series
	 * of actions, this EnhancedLeapableGenerator and its copy should behave
	 * identically.
	 *
	...
	/**
	 * Creates a copy of this EnhancedLeapableGenerator, leaps this
	 * EnhancedLeapableGenerator forward, and then returns the copy.
	 *
	...
	/**
	 * Changes the state of this EnhancedLeapableGenerator to leap a large fixed distance,
	 * indicated by the {@link #leapDistance} method, in its state cycle.
	 */
	@Override
	...
	/**
	 * <p>Gets an effectively unlimited stream of {@link EnhancedJumpableGenerator} objects,
	 * each wrapping an object of the same random number generator algorithm as this
	 * one. Although jumpable, the random number generators in the stream are not also leapable.</p>
	 *
	 * <p>The behavior of this method is identical to that of {@link #leaps}, but may be
	 * more convenient to use due to explicit return type of a stream of EnhancedJumpableGenerator
	 * objects.</p>
	 *
	...
	/**
	 * <p>Gets a stream of {@link EnhancedJumpableGenerator} objects,
	 * each wrapping an object of the same random number generator algorithm as this
	 * one. Although jumpable, the random number generators in the stream are not also leapable.</p>
	 *
	 * <p>The behavior of this method is identical to that of {@link #leaps(long)}, but may be
	 * more convenient to use due to explicit return type of a stream of EnhancedJumpableGenerator
	 * objects.</p>
	 *
	 ...
	 * interface returns a stream of {@link EnhancedJumpableGenerator} objects, and is thus
	 * safe to cast the objects of the stream to {@link EnhancedJumpableGenerator}. However,
	 * you may find it more convenient to instead utilize the {@link #eleaps} method, whose
	 ...
	 * interface returns a stream of {@link EnhancedJumpableGenerator} objects, and is thus
	 * safe to cast the objects of the stream to {@link EnhancedJumpableGenerator}. However,
	 * you may find it more convenient to instead utilize the {@link #eleaps(long)} method, whose
	 * behavior is identical aside from the return type.</p>
	 *
	 * @param streamSize the number of EnhancedJumpableGenerator objects in the stream
	 *

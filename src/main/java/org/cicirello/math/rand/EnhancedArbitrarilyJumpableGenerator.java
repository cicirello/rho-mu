...
/**
 * <p>An EnhancedArbitrarilyJumpableGenerator is used to wrap an object of any
 * class that implements {@link RandomGenerator.ArbitrarilyJumpableGenerator} for the purpose
 ...
 * wrapped object.</p>
 *
 * <p>The methods of the {@link RandomGenerator.ArbitrarilyJumpableGenerator} interface,
 * such as {@link #jumps(double)}, that return streams of RandomGenerator.ArbitrarilyJumpableGenerator
 * are implemented to return streams
 * of EnhancedArbitrarilyJumpableGenerator objects that wrap the RandomGenerator.ArbitrarilyJumpableGenerator
 * objects in the
 * streams returned by the enclosed RandomGenerator.ArbitrarilyJumpableGenerator. However, additionally
 * this class provides a counterpart, such as {@link #ejumps(double)}, for each of these methods
 * whose return type is explicitly a 
 * stream of EnhancedArbitrarilyJumpableGenerator objects to simplify usage without the need to cast
...
public class EnhancedArbitrarilyJumpableGenerator extends EnhancedLeapableGenerator implements RandomGenerator.ArbitrarilyJumpableGenerator {
	...
	/**
	 * Constructs an EnhancedArbitrarilyJumpableGenerator to wrap and enhance a given 
	 * {@link RandomGenerator.ArbitrarilyJumpableGenerator}.
	 *
	...
	/**
	 * Constructs the EnhancedArbitrarilyJumpableGenerator to wrap an instance of
	 * any random number generator supported by your version of Java
	 * as specified by its name, as documented via the 
	 * {@link RandomGenerator.ArbitrarilyJumpableGenerator#of}
	 * method.
	 *
	 * @param algorithmName The name of the random number generator as documented
	 * by the {@link RandomGenerator.ArbitrarilyJumpableGenerator#of} method.
	 *
	...
	/**
	 * Gets an EnhancedArbitrarilyJumpableGenerator wrapping an instance of
	 * any random number generator supported by your version of Java
	 * as specified by its name, as documented via the 
	 * {@link RandomGenerator.ArbitrarilyJumpableGenerator#of}
	 * method.
	 ...
	 * by the {@link RandomGenerator.ArbitrarilyJumpableGenerator#of} method.
	 *
	 * @return an EnhancedArbitrarilyJumpableGenerator wrapping an instance of your chosen
	...
	/**
	 * Creates and returns a new EnhancedArbitrarilyJumpableGenerator whose internal
	 * state is an exact copy of this one. Thus, if subjected to the same series
	 * of actions, this EnhancedArbitrarilyJumpableGenerator and its copy should behave
	 * identically.
	 *
	...
	/**
	 * Changes the state of this EnhancedArbitrarilyJumpableGenerator to jump a fixed distance
	 * ahead in its state cycle.
	 *
	 * @param distance the distance to jump ahead in the state cycle
	 */
	@Override
	...
	/**
	 * Changes the state of this EnhancedArbitrarilyJumpableGenerator to jump a distance
	 * of 2<sup>logDistance</sup> ahead in its state cycle.
	 *
	...
	/**
	 * <p>Gets an effectively unlimited stream of {@link EnhancedArbitrarilyJumpableGenerator} objects,
	 * each wrapping an object of the same random number generator algorithm as this
	 * one.</p>
	 *
	 * <p>The implementation of this method from the {@link RandomGenerator.ArbitrarilyJumpableGenerator}
	 * interface returns a stream of {@link EnhancedArbitrarilyJumpableGenerator} objects, and is thus
	 * safe to cast the objects of the stream to {@link EnhancedArbitrarilyJumpableGenerator}. However,
	 * you may find it more convenient to instead utilize the {@link #ejumps(double)} method, whose
	...
	/**
	 * <p>Gets a stream of {@link EnhancedArbitrarilyJumpableGenerator} objects,
	 * each wrapping an object of the same random number generator algorithm as this
	 * one.</p>
	 *
	 * <p>The implementation of this method from the {@link RandomGenerator.ArbitrarilyJumpableGenerator}
	 * interface returns a stream of {@link EnhancedArbitrarilyJumpableGenerator} objects, and is thus
	 * safe to cast the objects of the stream to {@link EnhancedArbitrarilyJumpableGenerator}. However,
	 * you may find it more convenient to instead utilize the {@link #ejumps(long, double)} method, whose
	 * behavior is identical aside from the return type.</p>
	 *
	...
	public final Stream<EnhancedArbitrarilyJumpableGenerator> ejumps(long streamSize, double distance) {
		return generator.jumps(streamSize, distance).map(gen -> new EnhancedArbitrarilyJumpableGenerator(gen));
	}

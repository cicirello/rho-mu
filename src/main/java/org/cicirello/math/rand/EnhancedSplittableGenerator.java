 ...
 * class that implements {@link RandomGenerator.SplittableGenerator} for the purpose
 ...
 * wrapped object.</p>
 *
 * <p>The methods of the {@link RandomGenerator.SplittableGenerator} interface,
 * such as {@link #splits}, that return streams of RandomGenerator.SplittableGenerator 
 * are implemented to return streams
 * of EnhancedSplittableGenerator objects that wrap the RandomGenerator.SplittableGenerator 
 * objects in the
 * streams returned by the enclosed RandomGenerator.SplittableGenerator. However, additionally
 * this class provides a counterpart, such as {@link #esplits}, for each of these 
 * whose return type is explicitly a 
 * stream of EnhancedSplittableGenerator objects to simplify usage without the need to cast
...
public class EnhancedSplittableGenerator extends EnhancedStreamableGenerator implements RandomGenerator.SplittableGenerator {
	 ...
	 * {@link RandomGenerator.SplittableGenerator}.
	 *
	...
	/**
	 * Gets an EnhancedSplittableGenerator wrapping an instance of
	 * any random number generator supported by your version of Java
	 * as specified by its name, as documented via the 
	 * {@link RandomGenerator.SplittableGenerator#of}
	 * method.
	 ...
	 * by the {@link RandomGenerator.SplittableGenerator#of} method.
	 *
	 * @return an EnhancedSplittableGenerator wrapping an instance of your chosen
	...
	/**
	 * Returns a new EnhancedSplittableGenerator split off from this one,
	 * such that the new one wraps a split of the wrapped random number generator.
	 *
	...
	/**
	 * <p>Gets an effectively unlimited stream of {@link EnhancedSplittableGenerator} objects.</p>
	 *
	 * <p>The behavior of this method is identical to that of {@link #splits}, but may be
	 * more convenient to use due to explicit return type of a stream of EnhancedSplittableGenerator
	 * objects.</p>
	 *
	...
	/**
	 * <p>Gets a stream of {@link EnhancedSplittableGenerator} objects.</p>
	 *
	 * <p>The behavior of this method is identical to that of {@link #splits(long)}, but may be
	 * more convenient to use due to explicit return type of a stream of EnhancedSplittableGenerator
	 * objects.</p>
	 *
	 ...
	 * {@link #splits(long, RandomGenerator.SplittableGenerator)}, but may be
	 * more convenient to use due to explicit return type of a stream of EnhancedSplittableGenerator
	 * objects.</p>
	 *
	 * @param streamSize the number of EnhancedSplittableGenerator objects in the stream
	 ...
	 *
	 * <p>The behavior of this method is identical to that of 
	 * {@link #splits(RandomGenerator.SplittableGenerator)}, but may be
	 * more convenient to use due to explicit return type of a stream of EnhancedSplittableGenerator
	 * objects.</p>
	 *
	 * @param source The source of randomness used to initialize the splits rather than this one.
	 ...
	 * interface returns a stream of {@link EnhancedSplittableGenerator} objects, and is thus
	 * safe to cast the objects of the stream to {@link EnhancedSplittableGenerator}. However,
	 * you may find it more convenient to instead utilize the {@link #esplits} method, whose
	 ...
	 * interface returns a stream of {@link EnhancedSplittableGenerator} objects, and is thus
	 * safe to cast the objects of the stream to {@link EnhancedSplittableGenerator}. However,
	 * you may find it more convenient to instead utilize the {@link #esplits(long)} method, whose
	 * behavior is identical aside from the return type.</p>
	 *
	 * @param streamSize the number of EnhancedSplittableGenerator objects in the stream
	 *
	 ...
	 * interface returns a stream of {@link EnhancedSplittableGenerator} objects, and is thus
	 * safe to cast the objects of the stream to {@link EnhancedSplittableGenerator}. However,
	 * you may find it more convenient to instead utilize the 
	 * {@link #esplits(long, RandomGenerator.SplittableGenerator)} method, whose
	 * behavior is identical aside from the return type.</p>
	 *
	 * @param streamSize the number of EnhancedSplittableGenerator objects in the stream
	 * @param source The source of randomness used to initialize the splits rather than this one.
	 ...
	 * safe to cast the objects of the stream to {@link EnhancedSplittableGenerator}. However,
	 * you may find it more convenient to instead utilize the 
	 * {@link #esplits(RandomGenerator.SplittableGenerator)} method, whose
	 * behavior is identical aside from the return type.</p>
	 *
	 * @param source The source of randomness used to initialize the splits rather than this one.
	 *

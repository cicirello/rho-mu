...
public final class MatrixOps {
   ...
   * @return The matrix is returned for convenience for passing to other methods requiring a matrix
   *     as parameter. It is the same object reference that was passed as a parameter.
   ...
   * @param A matrix
   * @param B matrix
   * @param C if C is null then a new matrix is constructed for result, otherwise C is used for
   *     result.
   ...
   * @return A reference to the C matrix.
   * @throws NullPointerException if either A or B is null.
   * @throws ArrayIndexOutOfBoundsException if number of columns of A is not equal to number of rows
   *     of B.
   * @throws ArrayIndexOutOfBoundsException if C is non-null, but dimensions inconsistent with A and
   *     B (must have same number of rows of A and same number of columns of B).
   */

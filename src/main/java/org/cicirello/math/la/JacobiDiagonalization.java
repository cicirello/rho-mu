...
public class JacobiDiagonalization {
   ...
   *
   * @return The eigenvectors are the columns of the returned matrix. Returns null if not yet
   *     computed.
   */
  ...
  /**
   * Computes the eigenvalues and eigenvectors using Jacobi Iteration. Uses the default precision
   * level JacobiDiagonalization.EPSILON where off-diagonal elements less than
   * JacobiDiagonalization.EPSILON in absolute value are set to 0. Uses the default max number of
   * iterations JacobiDiagonalization.MAX_ITERATIONS.
   *
   * @return true if Jacobi method converged, and false if terminated due to maximum number of
   *     iterations
   */
  ...
  /**
   * Computes the eigenvalues and eigenvectors using Jacobi Iteration. Uses the default max number
   * of iterations JacobiDiagonalization.MAX_ITERATIONS.
   *
   * @param epsilon Precision level, where off-diagonal elements less than epsilon in absolute value
   *     are set to 0.
   * @return true if Jacobi method converged, and false if terminated due to maximum number of
   *     iterations
   */
   ...
   * Computes the eigenvalues and eigenvectors using Jacobi Iteration. Uses the default precision
   * level JacobiDiagonalization.EPSILON where off-diagonal elements less than
   * JacobiDiagonalization.EPSILON in absolute value are set to 0.
   *

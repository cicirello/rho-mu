...
### Added
* EnhancedSplittableGenerator class, which is a wrapper for objects that implement
  RandomGenerator.SplittableGenerator, adding to those objects all of the functionality 
